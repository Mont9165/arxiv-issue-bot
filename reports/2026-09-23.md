...
- Links: [abs](http://arxiv.org/abs/2609.26749v1) | [pdf](https://arxiv.org/pdf/2609.26749v1)
...
### 7. FeatLens: Feature-Guided Dynamic Code Graph Construction and Retrieval for Repository-Level Code Generation
...
### 8. On the Lexical Superstition of Large Language Models for Code Comprehension: Re-evaluation on Code of Low Lexical Quality
...
### 9. Design and Evaluation of a Controlled Post-Alert Incident Orchestration and Response Subsystem Using a Rule Engine and a Local Large Language Model
...
### 10. Confidence-Guided Cross-Modal Knowledge Transfer for Multimodal Anomaly Detection in Microservice Systems
...
### 11. What Was Once Learned May Need to Be Unlearned: Machine Unlearning for Deprecated API Knowledge in Large Language Models
...
### 12. Understanding Maintenance and Support in a Community-Driven Scientific Workflow Ecosystem: A Cross-Space Study of Galaxy
...
### 13. An Empirical Analysis of Cross-OS Portability Issues in Python Projects

- arXiv ID: `2609.25531v1`
- Authors: Denini Silva, MohamadAli Farahat, Marcelo d'Amorim
- Published: 2026-09-22
- Categories: `cs.SE`
- Links: [abs](http://arxiv.org/abs/2609.25531v1) | [pdf](https://arxiv.org/pdf/2609.25531v1)
...
### 14. Dynamic Conformance Testing of WebGPU Through Specification-Driven Mutation
...
### 15. Modular Composition of Inductive Types Using Lean Meta-programming
...
### 16. Passes Alone, Fails Together: Benchmarking Semantic Coordination in Parallel LLM-Agent Development
...
### 17. SSP-Bench: A Hybrid Data Generation Framework for Safety, Security, and Privacy Evaluation
