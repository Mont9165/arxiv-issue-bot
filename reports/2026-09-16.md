...
### 4. TEAR: Table Extraction with Attribute Recommendation from Texts via Large Language Models
...
### 5. Chronos: Efficient Bolt-on Branching Across Data Stores for Stateful Agentic Applications
...
### 7. Natural Language Knowledge Graph Query Execution: Leveraging Controlled Semantics in the LLM Context Window
...
### 8. Towards Anticipatory Databases Through Shared Data and Workload Semantics
...
### 9. Semantic Knowledge Technologies: what the Semantic Web lost sight of, and what it never had
...
### 11. Numerical Stability of Linear Algebra Operations over Relational Databases
...
### 12. Cost Characterization of Vertically Partitioned Federated Knowledge Graphs
...
### 13. COMPASS: Steering Distributed Vector Search with Scientific Knowledge Graphs
...
### 14. Invisible Yet Dominant: Big Stalls of Kernel I/O Mechanisms in Cloud OLTP Databases
...
### 15. QEmbed: A Deep Learning Based Cardinality Estimator for Efficient Query Processing
...
### 16. Type-IV Code Clone Detection via Layer-Wise Non-Contrastive Representation Learning
...
### 17. Grounding SWE-Agent Decisions in Architecture-0 Design: Navigating Unknown Unknowns through Physical Mapping
...
### 18. A Set-Theoretic Evaluation Framework for Assessing Asset Administration Shell Instances: Towards Comparability and Suitability
...
### 19. TasmScan: Continuation-Aware Taint Analysis for TVM Bytecode with Savelist Abstraction
...
### 20. RepoAtlas: Guiding Coding Agents via Evolving Multimodal Repository Views

- arXiv ID: `2609.16936v1`
- Authors: Yunxiang Zhang, Haiquan Wang, JiaWei Guo, Hanyang Xia, Yan Chen, Tong Chen, Zhang Zhiwei, Junchen Ye
- Published: 2026-09-15
- Categories: `cs.SE`, `cs.AI`
- Links: [abs](http://arxiv.org/abs/2609.16936v1) | [pdf](https://arxiv.org/pdf/2609.16936v1)
...
### 21. Protocol-Preserving Context Trimming for Agentic Workflows: Benefits, Failure Regimes, and Budget Guardrails

- arXiv ID: `2609.16461v1`
- Authors: Harish Gaggar
- Published: 2026-09-15
- Categories: `cs.SE`, `cs.AI`
- Links: [abs](http://arxiv.org/abs/2609.16461v1) | [pdf](https://arxiv.org/pdf/2609.16461v1)
...
### 22. Evaluating the NIST Bugs Framework Against CWE as a Successor for Automated Vulnerability Classification
...
### 23. Adversarial Testing of Automated Program Repair Agents for Security Vulnerabilities
...
### 24. Coaching Qwen3 Coder 30B to Think Like a CodeClash Arena Agent

- arXiv ID: `2609.16096v1`
- Authors: Ivy Ning Zhang
- Published: 2026-09-14
- Categories: `cs.SE`, `cs.AI`
- Links: [abs](http://arxiv.org/abs/2609.16096v1) | [pdf](https://arxiv.org/pdf/2609.16096v1)
...
### 25. Translator vs. Challenger: Adversarial Agentic Learning for C-to-Rust Translation
...
### 26. LLM-enabled Behavior Driven Development Workflow for Formally Verified Hardware Designs
...
### 27. Externalizing Requirement-to-Repair Artifacts as Observable Traces for LLM-Based Program Repair
...
### 28. Toward Sustainable AI Deployment: A Carbon-Aware Decision Framework for Enterprise Supply Chain Systems
...
### 29. Efficiency Hallucination: Formalizing and Measuring Behavioral Calibration in LLM-Based Code Optimization

- arXiv ID: `2609.14839v1`
- Authors: Sarah Wilson, Gail Kaiser, Patrick Musau
- Published: 2026-09-13
- Categories: `cs.SE`, `cs.AI`
- Links: [abs](http://arxiv.org/abs/2609.14839v1) | [pdf](https://arxiv.org/pdf/2609.14839v1)
...
### 30. Enhancing Automated Unit Test Generation for NLP Libraries Using Large Language Models
